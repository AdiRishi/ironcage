...
| `money/reconcile`       | `apps/core`          | paired CSV/OFX rows match one-to-one; changed or missing balanced rows fail; 600-row exports create no coverage; statement totals and opening-to-closing chains agree                                                                                                                                | every push            |
