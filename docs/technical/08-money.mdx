...
<Steps>
  <Step title="Identity">Read and validate statement identity, number, and period.</Step>
  <Step title="Opening balance">Read the opening balance sentinel.</Step>
  <Step title="Enter the table">
    Enter the transaction table after the exact header set appears.
  </Step>
  <Step title="Start a transaction">Start a transaction when a valid day/month cell appears.</Step>
  <Step title="Continuation">
    Append continuation text while debit, credit, and balance do not complete a new row.
  </Step>
  <Step title="Complete">
    Complete the transaction when exactly one of debit or credit and one running balance are
    present.
  </Step>
  <Step title="Page furniture">
    Ignore repeated page headers and footers only when the profile recognizes them exactly.
  </Step>
  <Step title="Closing balance">Stop at the closing balance sentinel.</Step>
  <Step title="Validate">Validate summary totals and the closing balance.</Step>
</Steps>
