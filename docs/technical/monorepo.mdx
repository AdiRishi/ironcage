...
The layout and exports below describe the eventual ownership. Stage 1 needs web/API/processor and the relevant contracts/finance modules. Shared AI execution arrives in stage 2, analyst runtime in stage 6, and feature modules arrive with their stage. Do not create unused packages, exports, directories, or bindings for future consumers.
...
```text
apps/web/src/
  routes/                     route modules: URLs, loaders, HTTP handlers
