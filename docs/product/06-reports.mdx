---
title: Reports
description: The documents Ironcage writes — scheduled reviews, on-demand trial reports, and post-halt incident reports — and the rules that keep them grounded in the record.
sidebar:
  icon: file-text
---
...
| Report                                              | Cadence   | Trigger                                           |
| --------------------------------------------------- | --------- | ------------------------------------------------- |
| [Weekly sleeve review](#weekly-sleeve-review)       | Weekly    | Schedule, per active sleeve                       |
| [Weekly portfolio review](#weekly-portfolio-review) | Weekly    | Schedule, one for the system                      |
| [Monthly spending report](#monthly-spending-report) | Monthly   | After import, complete months only                |
| [Trial report](#trial-report)                       | On demand | Also automatic when a sleeve seeks promotion      |
| [Incident report](#incident-report)                 | —         | Automatic, on any halt or reconciliation mismatch |

### Weekly sleeve review
