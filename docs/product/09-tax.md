...
**Investor vs trader is surfaced, never decided.** The arm computes on the investor/CGT basis, marks the operator's own high-frequency sleeve activity distinctly, and states the question for the accountant. Trader status would be a different computation model, not a toggle.
