...
Every capability belongs to exactly one of four **safety classes** — and the classes are closed: adding a fifth is a constitutional change with its own written decision, never a feature.
