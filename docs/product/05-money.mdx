...
<Steps>
  <Step title="Select">The two files for one recent-history bundle, or one statement.</Step>
  <Step title="Preview">
...
5. Statement totals, balance sequences, account identity, and row order align statement observations with existing transactions.
