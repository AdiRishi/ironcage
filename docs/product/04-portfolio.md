...
- **Fund** — move cash into a sleeve, up to its cap. Typically follows a trial report; always recorded against it when it does. If the cash is not yet at the sleeve's venue, the act is recorded immediately but sits visibly **awaiting funding**: a transfer request is issued, and the sleeve's effective allocation rises only when the money lands. The decision is never blocked; the effect waits for reality.
