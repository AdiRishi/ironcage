...
| **Import bundle**              | The files submitted together for one account and source window. The enabled CommBank bundle contains paired CSV and OFX.                                                         | upload, import file (for a multi-file source)             |
| **Statement archive**          | One original statement PDF preserved against an operator-selected account without creating transactions or coverage.                                                             | statement import, import bundle                           |
