...
| **Import bundle**              | The files submitted together for one account and source window. A CommBank structured bundle contains paired CSV and OFX, while a statement bundle contains one PDF.             | upload, import file (for a multi-file source)             |
